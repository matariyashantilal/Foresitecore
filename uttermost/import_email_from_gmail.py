...
import excel2json
import shopify
from shopify_wrapper import views as shopify_helper
...
class ImportEmailFromGmail:
    ...
    def __init__(self):
        ...
        self.email_subject = os.environ.get(
            "emailsubject_inventorycountsuttermost")
                                ...
                                if fileExtension == "xls" or fileExtension == "xlsx" or fileExtension == "XLS" or fileExtension == "XLSX":
                                    ...
                                    if os.path.exists(attachment_dir+"/Uttermost Item Availability.json"):
                                        ...
                                        for p in AvailabilityProduct:
                                            tempAvailabilityProductSKU.append(
                                                p["SKU"])
                                        ...
                                        sps.uploadProduct(
                                            tempAvailabilityProductSKU, tempAvailabilityProductSKUList)
                                        logger.info(
                                            "Products has been updated successfully on shopify.")
                                    else:
                                        os.remove(filePath)
